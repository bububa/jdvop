...
type CheckDlokOrderRequest struct {
...
func (this *CheckDlokOrderRequest) Method() string {
	return "api/checkOrder/checkDlokOrder"
}

func (this *CheckDlokOrderRequest) Values() url.Values {
	values := url.Values{}
...
func (this *CheckDlokOrderRequest) Check(clt *jdvop.Client) (*CheckOrderResult, error) {
