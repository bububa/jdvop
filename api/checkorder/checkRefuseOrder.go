...
type CheckRefuseOrderRequest struct {
...
func (this *CheckRefuseOrderRequest) Method() string {
	return "api/checkOrder/checkRefuseOrder"
}

func (this *CheckRefuseOrderRequest) Values() url.Values {
	values := url.Values{}
...
func (this *CheckRefuseOrderRequest) Check(clt *jdvop.Client) (*CheckOrderResult, error) {
