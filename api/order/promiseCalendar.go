...
type PromiseCalendarRequest struct {
...
func (this *PromiseCalendarRequest) Method() string {
	return "api/order/promiseCalendar"
}

func (this *PromiseCalendarRequest) Values() url.Values {
	values := url.Values{}
...
func PromiseCalendar(clt *jdvop.Client, skus []SkuNum, province string, city string, county string, town string, paymentType int) (*PromiseCalendarResult, error) {
	req := &PromiseCalendarRequest{
		Skus:        skus,
		Province:    province,
		City:        city,
		County:      county,
